...
public class SwordmenUnit extends BaseUnit{
    ...
    public SwordmenUnit(double x, double y, double angle, int unitSize, PoliticalFaction faction, int unitWidth) {

        // Assign default attributes
        spacing = SwordmanConstants.SPACING;
        unitPatience = SwordmanConstants.UNIT_FIGHT_DELAY;
        currUnitPatience = SwordmanConstants.UNIT_FIGHT_DELAY;
        ...
        unitSpeed = SwordmanConstants.SPEED_STAT;
        ...
        for (int i = 0; i < unitSize; i++) {
            ...
            troops.add(new SwordmanSingle(singleX, singleY, politicalFaction, this, i));
        }
