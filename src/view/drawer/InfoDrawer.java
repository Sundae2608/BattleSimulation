...
public class InfoDrawer extends BaseDrawer {
     ...
     */
    public void drawTextBox(String s, double x, double y, double length) {
        ...
        applet.fill(255, 255, 255, 180);
        applet.rectMode(PApplet.CORNER);
        applet.rect((float) x - 5, (float) y - 5 - 18 * lines.length, (float) length, (float) 18 * lines.length + 10);
        applet.fill(0, 0, 0);
