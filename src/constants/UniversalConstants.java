...
public class UniversalConstants {
    ...
    // Unit pixel = 0.1m
    public final static double UNIT_SPACING = 30;

    // Size of each unit pixel wise at 100% zoom
    public final static float SINGLE_SIZE = 16;
    ...
    // Non rotation distance
    public final static double NON_ROTATION_DIST = 17;
    public final static double IN_POSITION_DIST = 36;
    ...
    public final static double ANGLE_ROTATION_SPEED = 0.2;
    public final static double ANGLE_ROTATION_SPEED_ARMY = 0.02;
    public final static double ANGLE_GRAPHIC_EPSILON = 0.02;
