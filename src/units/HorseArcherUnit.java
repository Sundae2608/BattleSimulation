...
import singles.HorseArcherSingle;
import utils.MathUtils;

import java.util.ArrayList;
import java.util.HashSet;

public class HorseArcherUnit extends BaseUnit{
    public HorseArcherUnit(double x, double y, double angle, int unitSize, PoliticalFaction faction, int unitWidth) {

        // Assign default attributes
        spacing = HorseArcherConstants.SPACING;
        unitPatience = HorseArcherConstants.UNIT_FIGHT_DELAY;
        currUnitPatience = HorseArcherConstants.UNIT_FIGHT_DELAY;
        ...
        unitSpeed = HorseArcherConstants.SPEED_STAT;
        ...
        for (int i = 0; i < unitSize; i++) {
            ...
            troops.add(new HorseArcherSingle(singleX, singleY, politicalFaction, this, i));
        }
